		...
		<BrowserRouter>
			<Switch>
				...
				<Route
					...
					exact
					component={ListarTransportadoraPage}
				></Route>
				<Route
					path="/transportadora/novo"
					exact
					component={CadastrarTransportadoraPage}
				></Route>
				<Route
					path="/transportadora/mostrar/:id"
					exact
					component={MostrarTransportadoraPage}
				></Route>
				<Route
					path="/transportadora/editar/:id"
					exact
					component={EditarTransportadoraPage}
				></Route>

				<Route
					path="/fornecedores"
					exact
					component={ListarFornecedorPage}
				></Route>
				<Route
				...
				></Route>
				<Route
					path="/fornecedor/mostrar/:id"
					exact
					component={MostrarFornecedorPage}
				></Route>
				<Route
					path="/fornecedor/editar/:id"
					exact
					component={EditarFornecedorPage}
				></Route>

				<Route
					path="/funcionarios"
					exact
					component={ListarFuncionarioPage}
				></Route>
				<Route
				...
				></Route>
				<Route
					path="/funcionario/mostrar/:id"
					exact
					component={MostrarFuncionarioPage}
				></Route>
				<Route
