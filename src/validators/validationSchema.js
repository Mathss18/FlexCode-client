...
export const clienteValidation = yup.object().shape({
  ...
  tipoContribuinte: yup.number("").nullable(),
  ...
  email: yup.string().email("Digite o e-mail corretamente").nullable(),
...
export const produtoValidation = yup.object().shape({
  ...
  codigoInterno: yup
    .string()
    .required("O código interno do produto é obrigatório"),
...
export const formasPagamentoValidation = yup.object().shape({
  ...
  conta_bancaria_id: yup
    .number("")
    .required("")
    .min(0, "Conta bancaria é obrigatória"),
  numeroMaximoParcelas: yup
    .number("")
    .required("Número máximo de parcelas é obrigatório")
    .min(1, "Deve ser maior que 0"),
  intervaloParcelas: yup
    .number("")
    .required("Intervalo de parcelas é obrigatório")
    .min(1, "Deve ser maior que 0"),
});
...
export const contasBancariasValidation = yup.object().shape({
  ...
  saldoInicial: yup
    .number("")
    .required("")
    .min(0, "Saldo Inicial é obrigatório"),
});
...
export const configuracaoValidation = yup.object().shape({
  tipoEmpresa: yup.string().required("O tipo da empresa é obrigatório"),
  situacao: yup.number("").required("A situação é obrigatória"),
  crt: yup.number("").required("O regime tributário é obrigatório"),
  inscricaoEstadual: yup.string().required("A IE é obrigatória"),
  nome: yup.string().required("O nome é obrigatório"),
  cpfCnpj: yup.string().required("O CPF/CNPJ é obrigatório"),
  email: yup
    .string()
  ...
  emailNfe: yup
    .string()
    .required("O email é obrigatório")
    .email("Digite o e-mail NFe corretamente"),
  rua: yup.string().required("Rua é obrigatório"),
  cidade: yup.string().required("Cidade é obrigatório"),
  numero: yup.string().required("Númerp é obrigatório"),
  cep: yup.string().required("CEP é obrigatório"),
  bairro: yup.string().required("Bairro é obrigatório"),
  estado: yup.string().required("Estado é obrigatório"),
  telefone: yup.string().required("Telefone é obrigatório"),
  celular: yup.string().required("Celular é obrigatório"),
  codigoMunicipio: yup.string().required("Código do municipio é obrigatório"),

  nNF: yup.number("").required("Campo obrigatório"),
  serie: yup.number("").required("Campo obrigatório"),
  ambiente: yup.number("").required("Campo obrigatório"),
  aliquota: yup.number("").required("Campo obrigatório"),
  quantidadeCasasDecimaisValor: yup.number("").required("Campo obrigatório"),
  quantidadeCasasDecimaisQuantidade: yup.number("").required("Campo obrigatório"),
  registrosPorPagina: yup.number("").required("Campo obrigatório"),
