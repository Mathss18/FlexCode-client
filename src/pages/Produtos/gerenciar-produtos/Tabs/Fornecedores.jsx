...
export function Fornecedores() {
  ...
  function handleCadastrarProduto() {
    ...
    api.post("/produtos", produtoContext.formik.values)
      .then(response => {
  ...
  useEffect(() => {
    api.get("/clientes").then(response => {
      ...
      produtoContext.useValues.setValues({ ...produtoContext.useValues.values, cliente_id: {} }); // Altera o State 
  ...
  useEffect(() => {
    api.get("/fornecedores").then(response => {
      ...
      produtoContext.useValues.setValues({ ...produtoContext.useValues.values, fornecedores_id: [] }); // Altera o State 
