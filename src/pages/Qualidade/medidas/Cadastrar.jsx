...
const medidaValidationCreate = Yup.object().shape({
...
function CadastrarMedidaPage() {
  ...
  const formik = useFormik({
    ...
    validationSchema: medidaValidationCreate,
  });
  ...
  function handleOnSubmit(values) {
    ...
    api
      ...
      .then((response) => {
        ...
        successAlert("Sucesso", "Medida Cadastrada");
      })
      .catch((error) => {
...
export default CadastrarMedidaPage;
