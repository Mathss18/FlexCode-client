...
import { Drawer, IconButton, List, Divider, ListItem, ListItemIcon, ListItemText, Collapse, ListSubheader } from '@material-ui/core/';
...
function SideMenu({ open, onOpenChange, children }) {
    ...
    const [openCadastroList, setOpenCadastroList] = useState(false);
